...
public class updateItem extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int productNumber=Integer.parseInt(jTextField4.getText());
        ...
        try
        {
            ...
            st.executeUpdate("UPDATE products SET productName = '" + productName + "', stock = '" + stock + "', price = '" + price + "' WHERE productNumber = '" + productNumber + "'");
        ...
        {
            JOptionPane.showMessageDialog(null,"error in updating Product");
        }
